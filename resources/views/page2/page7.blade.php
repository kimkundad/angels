			...
			<li data-index="rs-1" data-transition="fade" data-slotamount="default" 
             ...
             data-saveperformance="off">
				...
				<div class="tp-caption custom-caption-2 tp-shape tp-shapewrapper tp-resizeme rs-parallaxlevel-0" 
					...
					data-width="['740','740', 640','420','320']"
					data-height="auto"
					...
					data-fontsize="['32','32', '32','22','22']"
					data-lineheight="['70','60','60','45','35']"
					data-width="['840','740', 740','420','320']"
                    ...
                    <div class="caption-text">จัดตั้งบริษัทโฮลดิ้ง ทำแผนสืบทอดกิจการและธรรมนูญครอบครัว</div>
...
เครื่องมือที่นำมาใช้ในการส่งต่อได้แก่ การจัดตั้งบริษัทโฮลดิ้งที่ช่วยทั้งในแง่การบริหารความเสี่ยงและการบริหารภาษี การทำแผนสืบทอดกิจการที่จะช่วยในแง่การจัดสัดส่วนผู้ถือหุ้น การวางโครงสร้างของบริษัทในระยะยาว และธรรมนูญครอบครัวที่จะเป็นเสมือนคัมภีร์ของครอบครัวที่จะกำหนดกฏกติกาที่คนในครอบครัวต้องปฏิบัติตามจากรุ่นสู่รุ่นเพื่อให้การส่งต่อดำเนินไปอย่างราบรื่นและตามเจตนารมณ์ของคนในครอบครัว​
		...
		<li><a class="fb-share" href="https://www.facebook.com/sharer/sharer.php?u={{ url('/ที่ปรึกษาการทำประกันชีวิต_บุคคลสำคัญขององค์กร') }}&t=ที่ปรึกษาการทำประกันชีวิต_บุคคลสำคัญขององค์กร"
   onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"
   target="_blank" title="ที่ปรึกษาการทำประกันชีวิต_บุคคลสำคัญขององค์กร"><i class="fa fa-facebook"></i> Share</a></li>
            <li><a class="twitter-share" href="https://twitter.com/share?url={{ url('/ที่ปรึกษาการทำประกันชีวิต_บุคคลสำคัญขององค์กร') }}&via=wealthangels&text=ที่ปรึกษาการทำประกันชีวิต_บุคคลสำคัญขององค์กร"
   onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"
   target="_blank" title="ที่ปรึกษาการทำประกันชีวิต_บุคคลสำคัญขององค์กร"><i class="fa fa-twitter"></i> Tweet</a></li>
        </ul>
...
<ul id="posts-nav" class="margin-top-0 margin-bottom-45">
    <li class="next-post">
        <a href="{{ url('สัมมนาให้ความรู้การเงินแก่พนักงาน') }}"><span>Next</span>
        สัมมนาให้ความรู้การเงินแก่พนักงาน</a>
    </li>
    <li class="prev-post">
        <a href="{{ url('ที่ปรึกษาการทำประกันชีวิต_บุคคลสำคัญขององค์กร') }}"><span>Previous </span>
        ที่ปรึกษาการทำประกันชีวิต บุคคลสำคัญขององค์กร</a>
    </li>
</ul>
