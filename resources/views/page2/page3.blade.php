...
<div class="blog-post single-post">
    ...
    <div class="post-content">
        ...
        <h3>ให้คำปรึกษาสร้างสวัสดิการแก่พนักงาน</h3>
...
<ul id="posts-nav" class="margin-top-0 margin-bottom-45">
    <li class="next-post">
        <a href="{{ url('ที่ปรึกษาด้านบัญชีและภาษีสำหรับองค์กร') }}"><span>Next</span>
        ที่ปรึกษาด้านบัญชีและภาษีสำหรับองค์กร</a>
    </li>
    <li class="prev-post">
        <a href="{{ url('ให้คำปรึกษาสร้างสวัสดิการแก่พนักงาน') }}"><span>Previous </span>
