...
@section('title')
สัมมนาให้ความรู้การเงินแก่พนักงาน || Wealth Angels
@stop
...
<div class="blog-post single-post">
    ...
    <div class="post-content">
        ...
        <h3>สัมมนาให้ความรู้การเงินแก่พนักงาน</h3>


        <p>
        ทีมงานของเรามีความชำนาญ ในการทำสัมมนาให้ความรู้ทางด้านการเงิน เพื่อให้บุคคลากรขององค์กรตระหนักรู้เรื่องความสำคัญของการวางแผนการเงินในองค์รวม ทั้งนี้หากพนักงานในองค์กรมีสุขภาพทางการเงินที่ดี ก็จะนำพาประสิทธิภาพการทำงานที่ดีมาสู่องค์กรของท่าน หัวข้อสัมมนาของเราครอบคลุมในหลายๆเรื่องอาทิเช่น
        </p>

        <div class="post-quote">
            <span class="icon"></span>
            <blockquote>
                - วางแผนการเงินอย่างไรให้ชีวิตปัง  <br>
                - วางแผนภาษี รู้เขารู้เรา <br>
                - เกษียณอย่างเพียงพอทำได้ไม่ยาก <br>
                - กฎหมายแรงงานกับสิ่งที่พนักงานควรรู้ <br>
                - ประกันสังคมกับกองทุนทดแทนให้อะไรบ้าง <br>
            </blockquote>
        </div>
...
<li><a class="fb-share" href="https://www.facebook.com/sharer/sharer.php?u={{ url('/สัมมนาให้ความรู้การเงินแก่พนักงาน') }}&t=สัมมนาให้ความรู้การเงินแก่พนักงาน"
   onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"
   target="_blank" title="สัมมนาให้ความรู้การเงินแก่พนักงาน"><i class="fa fa-facebook"></i> Share</a></li>
            <li><a class="twitter-share" href="https://twitter.com/share?url={{ url('/สัมมนาให้ความรู้การเงินแก่พนักงาน') }}&via=wealthangels&text=สัมมนาให้ความรู้การเงินแก่พนักงาน"
   onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"
   target="_blank" title="สัมมนาให้ความรู้การเงินแก่พนักงาน"><i class="fa fa-twitter"></i> Tweet</a></li>
</ul>
