			...
			<li data-index="rs-1" data-transition="fade" data-slotamount="default" 
             ...
             data-saveperformance="off">
				...
				<div class="tp-caption custom-caption-2 tp-shape tp-shapewrapper tp-resizeme rs-parallaxlevel-0" 
                    ...
                    <div class="caption-text">ที่ปรึกษาการทำประกันชีวิต บุคคลสำคัญขององค์กร</div>
...
<div class="blog-post single-post">
    ...
    <div class="post-content">
        ...
        <h3>ที่ปรึกษาการทำประกันชีวิต บุคคลสำคัญขององค์กร</h3>
...
การทำประกัน keyman เป็นเรื่องที่ต้องมีการวางแผนจากผู้ที่มีความเชี่ยวชาญเพื่อให้เกิดประโยชน์ทั้งจากการลดความเสี่ยง วางแผนภาษีทั้งขององค์กรและตัว keyman เอง และยังสามารถนำมาใช้เป็นส่วนหนึ่งของการวางแผนสืบทอดกิจการได้ด้วย​
		...
		<li><a class="fb-share" href="https://www.facebook.com/sharer/sharer.php?u={{ url('/ที่ปรึกษาด้านการซื้อขายกิจการ') }}&t=ที่ปรึกษาด้านการซื้อขายกิจการ"
   onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"
   target="_blank" title="ที่ปรึกษาด้านการซื้อขายกิจการ"><i class="fa fa-facebook"></i> Share</a></li>
            <li><a class="twitter-share" href="https://twitter.com/share?url={{ url('/ที่ปรึกษาด้านการซื้อขายกิจการ') }}&via=wealthangels&text=ที่ปรึกษาด้านการซื้อขายกิจการ"
   onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"
   target="_blank" title="ที่ปรึกษาด้านการซื้อขายกิจการ"><i class="fa fa-twitter"></i> Tweet</a></li>
        </ul>
...
<ul id="posts-nav" class="margin-top-0 margin-bottom-45">
    <li class="next-post">
        <a href="{{ url('จัดตั้งบริษัทโฮลดิ้ง_ทำแผนสืบทอดกิจการและธรรมนูญครอบครัว') }}"><span>Next</span>
        จัดตั้งบริษัทโฮลดิ้ง ทำแผนสืบทอดกิจการและธรรมนูญครอบครัว</a>
    </li>
    <li class="prev-post">
        <a href="{{ url('ที่ปรึกษาด้านการซื้อขายกิจการ') }}"><span>Previous </span>
        ที่ปรึกษาด้านการซื้อขายกิจการ</a>
    </li>
</ul>
