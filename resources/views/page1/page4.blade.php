			...
			<li data-index="rs-1" data-transition="fade" data-slotamount="default" 
             ...
             data-saveperformance="off">
				...
				<div class="tp-caption custom-caption-2 tp-shape tp-shapewrapper tp-resizeme rs-parallaxlevel-0" 
					...
					data-responsive="off"
					style="z-index: 6; color: #fff; letter-spacing: 0px; font-weight: 600; ">วางแผนการศึกษา</div>

					<div class="caption-text">สิ่งสำคัญที่พ่อแม่ต้องการมอบให้แก่ลูกคือการศึกษา การศึกษาถือเป็นอาวุธที่จะติดตัวลูกให้เค้าสามารถสร้างความมั่งคั่งให้แก่ตนเองในอนาคต   </div>
...
<div class="blog-post single-post">
    ...
    <div class="post-content">
        ...
        <div class="post-quote">
            ...
            <blockquote>
                - วิเคราะห์และนำเสนอแผนการศึกษาบุตรในแต่ละแนวทางให้แก่ลูกค้าได้พิจารณาในเรื่องข้อดีข้อเสีย โดยเฉพาะในด้านค่าใช้จ่าย <br>
                - สร้างเป้าหมายการศึกษาบุตรร่วมกับลูกค้าและวิเคราะห์ค่าใช้จ่ายทั้งหมด <br>
                - วิเคราะห์เงินที่ต้องลงทุนต่อปีและอัตราผลตอบแทนที่ต้องการ <br>
                - วางแผนการออมและการลงทุนเพื่อตอบโจทย์เป้าหมาย <br>
                - เชื่อมโยงแผนการศึกษากับแผนอื่นๆ อาทิเช่น แผนการลงทุน แผนบริหารความเสี่ยง เพื่อนำมาใช้ในการเลือกผลิตภัณฑ์ต่อไป <br>
            </blockquote>
        </div>
		...
		<li><a class="fb-share" href="https://www.facebook.com/sharer/sharer.php?u={{ url('/วางแผนการศึกษา') }}&t=วางแผนการศึกษา"
	onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"
	target="_blank" title="วางแผนการศึกษา"><i class="fa fa-facebook"></i> Share</a></li>
				<li><a class="twitter-share" href="https://twitter.com/share?url={{ url('/วางแผนการศึกษา') }}&via=wealthangels&text=วางแผนการศึกษา"
	onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"
	target="_blank" title="วางแผนการศึกษา"><i class="fa fa-twitter"></i> Tweet</a></li>
        </ul>
...
<ul id="posts-nav" class="margin-top-0 margin-bottom-45">
    <li class="next-post">
        <a href="{{ url('วางแผนบริหารความเสี่ยง') }}"><span>Next</span>
        วางแผนบริหารความเสี่ยง</a>
    </li>
    <li class="prev-post">
        <a href="{{ url('วางแผนภาษี') }}"><span>Previous </span>
        วางแผนภาษี</a>
    </li>
</ul>
