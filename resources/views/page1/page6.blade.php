			...
			<li data-index="rs-1" data-transition="fade" data-slotamount="default" 
             ...
             data-saveperformance="off">
				...
				<div class="tp-caption custom-caption-2 tp-shape tp-shapewrapper tp-resizeme rs-parallaxlevel-0" 
					...
					data-responsive="off"
					style="z-index: 6; color: #fff; letter-spacing: 0px; font-weight: 600; ">วางแผนมรดก</div>

					<div class="caption-text">การวางแผนมรดกเป็นสิ่งสำคัญที่จะช่วยให้การส่งต่อความมั่งคั่งให้ลูกหลานมีความราบรื่นและลดข้อขัดแย้ง บริการของเราครอบคลุมถึงด้านต่างๆดังนี้​  </div>
...
<div class="blog-post single-post">
    ...
    <div class="post-content">
        ...
        <div class="post-quote">
            ...
            <blockquote>
                - การจัดทำบัญชีทรัพย์สิน  <br>
                - การจัดทำพินัยกรรม <br>
                - การวางแผนภาษีมรดก <br>
                - การจัดทำธรรมนูญครอบครัว <br>
            </blockquote>
        </div>
		...
		<li><a class="fb-share" href="https://www.facebook.com/sharer/sharer.php?u={{ url('/วางแผนมรดก') }}&t=วางแผนมรดก"
	onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"
	target="_blank" title="วางแผนมรดก"><i class="fa fa-facebook"></i> Share</a></li>
				<li><a class="twitter-share" href="https://twitter.com/share?url={{ url('/วางแผนมรดก') }}&via=wealthangels&text=วางแผนมรดก"
	onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"
	target="_blank" title="วางแผนมรดก"><i class="fa fa-twitter"></i> Tweet</a></li>
        </ul>
...
<ul id="posts-nav" class="margin-top-0 margin-bottom-45">
    <li class="next-post">
        <a href="{{ url('วางแผนลงทุน') }}"><span>Next</span>
        วางแผนลงทุน</a>
    </li>
    <li class="prev-post">
        <a href="{{ url('วางแผนบริหารความเสี่ยง​') }}"><span>Previous </span>
