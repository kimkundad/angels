			...
			<li data-index="rs-1" data-transition="fade" data-slotamount="default" 
             ...
             data-saveperformance="off">
				...
				<div class="tp-caption custom-caption-2 tp-shape tp-shapewrapper tp-resizeme rs-parallaxlevel-0" 
					...
					<div class="caption-text">การวางแผนลงทุนเป็นส่วนสำคัญที่ทำให้สินทรัพย์งอกเงย โดยแนวทางการวางแผนของแต่ละบุคคลจะแตกต่างกันไปขึ้นอยู่กับปัจจัยหลายอย่างที่เราต้องนำมาพิจารณา บริการของเราจะครอบคลุมในเรื่องต่างๆดังนี้​</div>
...
<div class="blog-post single-post">
    ...
    <div class="post-content">
        ...
        <div class="post-quote">
            ...
            <blockquote>
                - สรุปข้อมูลการลงทุนของลูกค้าและนำมาวิเคราะห์​ <br>
                - คำนวณอัตราผลตอบแทนในปัจจุบัน​ <br>
                - สร้างเป้าหมายร่วมกับลูกค้าและคำนวณอัตราผลตอบแทนในอนาคตที่ต้องการ <br>
                - จัดพอร์ตการลงทุนตามแต่ละเป้าหมายและระยะเวลาการลงทุน <br>
                - นำเสนอผลิตภัณฑ์การลงทุนที่ช่วยตอบโจทย์เป้าหมายการลงทุน <br>
                - ทบทวนแผนการลงทุนอย่างสม่ำเสมอและปรับเปลี่ยนแผนตามสมควร <br>
            </blockquote>
        </div>
   ...
   target="_blank" title="วางแผนการลงทุน"><i class="fa fa-facebook"></i> Share</a></li>
            <li><a class="twitter-share" href="https://twitter.com/share?url={{ url('/วางแผนการลงทุน') }}&via=wealthangels&text=วางแผนการลงทุน"
   onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"
   target="_blank" title="วางแผนการลงทุน"><i class="fa fa-twitter"></i> Tweet</a></li>
...
<ul id="posts-nav" class="margin-top-0 margin-bottom-45">
    <li class="next-post">
        <a href="{{ url('วางแผนเกษียณ') }}"><span>Next</span>
            วางแผนเกษียณ</a>
    </li>
    <li class="prev-post">
