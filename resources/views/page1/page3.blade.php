			...
			<li data-index="rs-1" data-transition="fade" data-slotamount="default" 
             ...
             data-saveperformance="off">
				...
				<div class="tp-caption custom-caption-2 tp-shape tp-shapewrapper tp-resizeme rs-parallaxlevel-0" 
					...
					data-responsive="off"
					style="z-index: 6; color: #fff; letter-spacing: 0px; font-weight: 600; ">วางแผนภาษี</div>

					<div class="caption-text">ภาษีเป็นหนึ่งในค่าใช้จ่ายก้อนใหญ่ที่ทุกคนต้องวางแผน ไม่ว่าจะเป็นการวางแผนการจ่ายภาษีที่ถูกต้อง ครบถ้วน  </div>
...
<div class="blog-post single-post">
    ...
    <div class="post-content">
        ...
        <div class="post-quote">
            ...
            <blockquote>
                - วางแผนการจ่ายภาษีที่ถูกต้องและครบถ้วน <br>
                - วางแผนการจ่ายภาษีให้ได้ประโยชน์สูงสุดจากสิทธิ์ที่มีตามกฎหมาย <br>
                - วางแผนการออมและการลงทุนทุกเดือนสำหรับการจ่ายภาษี <br>
            </blockquote>
        </div>
        ...
        <ul class="share-buttons margin-top-40 margin-bottom-0">
			<li><a class="fb-share" href="https://www.facebook.com/sharer/sharer.php?u={{ url('/วางแผนภาษี') }}&t=วางแผนภาษี"
	onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"
	target="_blank" title="วางแผนภาษี"><i class="fa fa-facebook"></i> Share</a></li>
				<li><a class="twitter-share" href="https://twitter.com/share?url={{ url('/วางแผนภาษี') }}&via=wealthangels&text=วางแผนภาษี"
	onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"
	target="_blank" title="วางแผนภาษี"><i class="fa fa-twitter"></i> Tweet</a></li>
        </ul>
...
<ul id="posts-nav" class="margin-top-0 margin-bottom-45">
    <li class="next-post">
        <a href="{{ url('วางแผนการศึกษา') }}"><span>Next</span>
        วางแผนการศึกษา</a>
    </li>
    <li class="prev-post">
        <a href="{{ url('วางแผนเกษียณ') }}"><span>Previous </span>
        วางแผนเกษียณ</a>
    </li>
</ul>
