			...
			<li data-index="rs-1" data-transition="fade" data-slotamount="default" 
             ...
             data-saveperformance="off">
				...
				<div class="tp-caption custom-caption-2 tp-shape tp-shapewrapper tp-resizeme rs-parallaxlevel-0" 
					...
					data-responsive="off"
					style="z-index: 6; color: #fff; letter-spacing: 0px; font-weight: 600; ">วางแผนเกษียณ</div>

					<div class="caption-text">การวางแผนเกษียณคือการเตรียมความพร้อมทางการเงินสำหรับช่วงระยะเวลาที่เราเลิกทำงานหรือไม่มีรายได้เข้ามา ซึ่งส่วนใหญ่จะคิดเป็นระยะเวลาตั้งแต่ 20-40 ปี </div>
...
<div class="blog-post single-post">
    ...
    <div class="post-content">
        ...
        <p>
        การวางแผนเกษียณคือการเตรียมความพร้อมทางการเงินสำหรับช่วงระยะเวลาที่เราเลิกทำงานหรือไม่มีรายได้เข้ามา ซึ่งส่วนใหญ่จะคิดเป็นระยะเวลาตั้งแต่ 20-40 ปี ตั้งแต่วันที่เราเลิกทำงานจนถึงวันที่เราเสียชีวิต 
        ดังนั้นการไม่วางแผนเกษียณหรือการวางแผนที่ไม่เป็นระบบจะส่งผลกระทบอย่างใหญ่หลวงกับคุณภาพชีวิตของเราในบั้นปลาย เราตระหนักถึงความสำคัญของการวางแผนเกษียณ จึงให้บริการที่ครอบคลุมในด้านต่างๆดังนี้
        </p>

        <div class="post-quote">
            <span class="icon"></span>
            <blockquote>
                - สรุปข้อมูลรายรับรายจ่ายของลูกค้าเพื่อนำมาประเมินกระแสเงินสดที่จะนำมาใช้ในแต่ละปีอย่างเหมาะสม <br>
                - สรุปข้อมูลสินทรัพย์หนี้สินของลูกค้าเพื่อนำมาออกแบบการเพิ่มผลตอบแทนและการกระจายความเสี่ยงเพื่อให้ความมั่งคั่งมากขึ้น <br>
                - สร้างเป้าหมายเกษียณร่วมกับลูกค้าและวิเคราะห์ค่าใช้จ่ายทั้งหมด <br>
                - วิเคราะห์เงินที่ต้องลงทุนต่อปีและอัตราผลตอบแทนที่ต้องการ <br>
                - วางแผนการออมและการลงทุนเพื่อตอบโจทย์เป้าหมาย <br>
                - เชื่อมโยงแผนเกษียณกับแผนอื่นๆ อาทิเช่น แผนการลงทุน แผนการบริหารความเสี่ยง เพื่อนำมาใช้ในการเลือกผลิตภัณฑ์ต่อไป <br>
            </blockquote>
        </div>
		...
		<li><a class="fb-share" href="https://www.facebook.com/sharer/sharer.php?u={{ url('/วางแผนเกษียณ') }}&t=วางแผนเกษียณ"
   onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"
   target="_blank" title="วางแผนเกษียณ"><i class="fa fa-facebook"></i> Share</a></li>
            <li><a class="twitter-share" href="https://twitter.com/share?url={{ url('/วางแผนเกษียณ') }}&via=wealthangels&text=วางแผนเกษียณ"
   onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"
   target="_blank" title="วางแผนเกษียณ"><i class="fa fa-twitter"></i> Tweet</a></li>
        </ul>
...
<ul id="posts-nav" class="margin-top-0 margin-bottom-45">
    <li class="next-post">
        <a href="{{ url('วางแผนภาษี') }}"><span>Next</span>
        วางแผนภาษี</a>
    </li>
    <li class="prev-post">
        <a href="{{ url('วางแผนการลงทุน') }}"><span>Previous </span>
        วางแผนการลงทุน</a>
    </li>
</ul>
...
<!-- Content / End -->
	...
	<div class="col-lg-4 col-md-4">
		<div class="sidebar right">
            ...
            <h3>เรื่องอื่นๆ ที่เกี่ยวข้อง</h3>
				<ul class="widget-tabs">
					...
					<li>
						<div class="widget-content">
							<div class="widget-text">
								<h5><a href="{{ url('วางแผนการลงทุน') }}">วางแผนการลงทุน</a></h5>
							</div>
							<div class="clearfix"></div>
						</div>
					</li>
					...
					<li>
						<div class="widget-content">
							<div class="widget-text">
								<h5><a href="{{ url('วางแผนเกษียณ') }}">วางแผนเกษียณ</a></h5>
							</div>
							<div class="clearfix"></div>
						</div>
					</li>
					<li>
						<div class="widget-content">
							<div class="widget-text">
								<h5><a href="{{ url('วางแผนภาษี') }}">วางแผนภาษี</a></h5>
							</div>
							<div class="clearfix"></div>
						</div>
					</li>
					<li>
						<div class="widget-content">
							<div class="widget-text">
								<h5><a href="{{ url('วางแผนการศึกษา') }}">วางแผนการศึกษา</a></h5>
							</div>
							<div class="clearfix"></div>
						</div>
					</li>
					<li>
						<div class="widget-content">
							<div class="widget-text">
								<h5><a href="{{ url('วางแผนบริหารความเสี่ยง') }}">วางแผนบริหารความเสี่ยง</a></h5>
							</div>
							<div class="clearfix"></div>
						</div>
					</li>
					<li>
						<div class="widget-content">
							<div class="widget-text">
								<h5><a href="{{ url('วางแผนมรดก') }}">วางแผนมรดก</a></h5>
							</div>
							<div class="clearfix"></div>
						</div>
					</li>
