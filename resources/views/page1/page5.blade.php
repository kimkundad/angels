...
@section('title')
วางแผนบริหารความเสี่ยง || Wealth Angels
@stop
			...
			<li data-index="rs-1" data-transition="fade" data-slotamount="default" 
             ...
             data-saveperformance="off">
				...
				<div class="tp-caption custom-caption-2 tp-shape tp-shapewrapper tp-resizeme rs-parallaxlevel-0" 
					...
					data-responsive="off"
					style="z-index: 6; color: #fff; letter-spacing: 0px; font-weight: 600; ">วางแผนบริหารความเสี่ยง</div>

					<div class="caption-text">การโอนความเสี่ยงไปที่บริษัทประกัน เปรียบเสมือนการอุดรอยรั่วทางการเงินที่มักเกิดจากสิ่งที่เราไม่คาดฝัน ถ้าเราวางแผนประกันได้เป็นอย่างดี   </div>
...
<div class="blog-post single-post">
    ...
    <div class="post-content">
        ...
        <div class="post-quote">
            ...
            <blockquote>
                - วิเคราะห์ความต้องการและความจำเป็นในการทำประกันของลูกค้า  <br>
                - สรุปรายละเอียดประกันเดิมที่ลูกค้ามีเพื่อให้ลูกค้าเข้าใจสถานภาพความเสี่ยงของตนในปัจจุบัน <br>
                - นำเสนอแบบประกันที่หลากหลายและตอบโจทย์ความต้องการของลูกค้า <br>
                - วิเคราะห์เงินที่ต้องใช้ต่อปีและความคุ้มครองที่จะได้รับในระยะยาว <br>
                - เชื่อมโยงแผนบริหารความเสี่ยงกับแผนอื่นๆ เชื่อมโยงแผนบริหารความเสี่ยงกับแผนอื่นๆ อาทิเช่น แผนการลงทุน แผนเกษียณ เพื่อนำมาใช้ในการเลือกผลิตภัณฑ์ต่อไป <br>
            </blockquote>
        </div>
		...
		<li><a class="fb-share" href="https://www.facebook.com/sharer/sharer.php?u={{ url('/วางแผนบริหารความเสี่ยง') }}&t=วางแผนบริหารความเสี่ยง"
	onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"
	target="_blank" title="วางแผนบริหารความเสี่ยง"><i class="fa fa-facebook"></i> Share</a></li>
				<li><a class="twitter-share" href="https://twitter.com/share?url={{ url('/วางแผนบริหารความเสี่ยง') }}&via=wealthangels&text=วางแผนบริหารความเสี่ยง"
	onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"
	target="_blank" title="วางแผนบริหารความเสี่ยง"><i class="fa fa-twitter"></i> Tweet</a></li>
        </ul>
...
<ul id="posts-nav" class="margin-top-0 margin-bottom-45">
    <li class="next-post">
        <a href="{{ url('วางแผนมรดก') }}"><span>Next</span>
        วางแผนมรดก</a>
    </li>
    <li class="prev-post">
        <a href="{{ url('วางแผนการศึกษา') }}"><span>Previous </span>
        วางแผนการศึกษา</a>
    </li>
</ul>
