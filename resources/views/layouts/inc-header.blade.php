				...
				<nav id="navigation" class="style-1">
					<ul id="responsive">
						...
						<li><a href="#">บริการองค์กร</a>
							<ul>
								<li><a href="{{ url('สัมมนาให้ความรู้การเงินแก่พนักงาน') }}">จัดสัมมนา</a></li>
								<li><a href="{{ url('ให้คำปรึกษาสร้างสวัสดิการแก่พนักงาน') }}">สร้างสวัสดิการพนักงาน</a></li>
								<li><a href="{{ url('จัดตั้งกองทุนสำรองเลี้ยงชีพ') }}">ตั้งกองทุนสำรองเลี้ยงชีพ</a></li>
								<li><a href="{{ url('ที่ปรึกษาด้านบัญชีและภาษีสำหรับองค์กร') }}#">ให้คำปรึกษาด้านบัญชีภาษี</a></li>
								<li><a href="{{ url('ที่ปรึกษาด้านการซื้อขายกิจการ') }}#">ให้คำปรึกษาซื้อขายกิจการ</a></li>
								<li><a href="{{ url('ที่ปรึกษาการทำประกันชีวิต_บุคคลสำคัญขององค์กร') }}#">ทำประกันบุคคลสำคัญองค์กร</a></li>
								<li><a href="{{ url('จัดตั้งบริษัทโฮลดิ้ง_ทำแผนสืบทอดกิจการและธรรมนูญครอบครัว') }}#">จัดตั้งบริษัทโฮลดิ้ง ทำแผนสืบทอด</a></li>
							</ul>
						</li>
						<li><a href="#">ผลิตภัณฑ์ที่เกี่ยวข้อง</a>
							<ul>
								...
								<li><a href="{{ url('สินทรัพย์_ทางเลือก') }}">สินทรัพย์ ทางเลือก</a></li>
							</ul>
						</li>
						<li><a href="#">คลาสการเงิน</a>
							<ul>
