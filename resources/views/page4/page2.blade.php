...
@section('title')
คลาสสอนการเงินให้เด็กก่อนวัยรุ่น || Wealth Angels
@stop
			...
			<li data-index="rs-1" data-transition="fade" data-slotamount="default" 
             ...
             data-saveperformance="off">
				...
				<div class="tp-caption custom-caption-2 tp-shape tp-shapewrapper tp-resizeme rs-parallaxlevel-0" 
					...
					data-responsive="off"
					style="z-index: 6; color: #fff; letter-spacing: 0px; font-weight: 600; ">คลาสสอนการเงินให้เด็กก่อนวัยรุ่น</div>
...
<div class="blog-post single-post">
    ...
    <div class="post-content">
        ...
        <h3>คลาสสอนการเงินให้เด็กก่อนวัยรุ่น</h3>
...
คลาสทางการเงินสำหรับเด็กก่อนวัยรุ่น (8-13 ปี) กำลังอยู่ระหว่างการเตรียมการ และจะแจ้งให้ทราบเร็วๆนี้​
		...
		<li><a class="fb-share" href="https://www.facebook.com/sharer/sharer.php?u={{ url('/คลาสสอนการเงินให้เด็กก่อนวัยรุ่น') }}&t=คลาสสอนการเงินให้เด็กก่อนวัยรุ่น"
   onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"
   target="_blank" title="คลาสสอนการเงินให้เด็กก่อนวัยรุ่น"><i class="fa fa-facebook"></i> Share</a></li>
            <li><a class="twitter-share" href="https://twitter.com/share?url={{ url('/คลาสสอนการเงินให้เด็กก่อนวัยรุ่น') }}&via=wealthangels&text=คลาสสอนการเงินให้เด็กก่อนวัยรุ่น"
   onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"
   target="_blank" title="คลาสสอนการเงินให้เด็กก่อนวัยรุ่น"><i class="fa fa-twitter"></i> Tweet</a></li>
        </ul>
...
<ul id="posts-nav" class="margin-top-0 margin-bottom-45">
    <li class="next-post">
        <a href="{{ url('คลาสการเงินสำหรับผู้ใหญ่') }}"><span>Next</span>
        คลาสการเงินสำหรับผู้ใหญ่</a>
    </li>
    <li class="prev-post">
        <a href="{{ url('คำนวณการเงินแบบง่ายๆ') }}"><span>Previous </span>
