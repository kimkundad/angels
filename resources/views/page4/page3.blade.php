...
@section('title')
คลาสการเงินสำหรับผู้ใหญ่ || Wealth Angels
@stop
			...
			<li data-index="rs-1" data-transition="fade" data-slotamount="default" 
             ...
             data-saveperformance="off">
				...
				<div class="tp-caption custom-caption-2 tp-shape tp-shapewrapper tp-resizeme rs-parallaxlevel-0" 
					...
					data-responsive="off"
					style="z-index: 6; color: #fff; letter-spacing: 0px; font-weight: 600; ">คลาสการเงินสำหรับผู้ใหญ่</div>
...
<div class="blog-post single-post">
    ...
    <div class="post-content">
        ...
        <h3>คลาสการเงินสำหรับผู้ใหญ่</h3>
        ...
        <br>เราจึงมีความตั้งใจที่อยากจะสร้างคลาสการเงินเพื่อเติมเต็มองค์ความรู้นี้และสามารถนำมาใช้ได้จริงในทางปฏิบัติ​
<br>
 คลาสทางการเงินสำหรับผู้ใหญ่ กำลังอยู่ระหว่างการเตรียมการ และจะแจ้งให้ทราบเร็วๆนี้​
</p>
        <!-- Share Buttons -->
        <ul class="share-buttons margin-top-40 margin-bottom-0">
		<li><a class="fb-share" href="https://www.facebook.com/sharer/sharer.php?u={{ url('/คลาสการเงินสำหรับผู้ใหญ่') }}&t=คลาสการเงินสำหรับผู้ใหญ่"
   onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"
   target="_blank" title="คลาสการเงินสำหรับผู้ใหญ่"><i class="fa fa-facebook"></i> Share</a></li>
            <li><a class="twitter-share" href="https://twitter.com/share?url={{ url('/คลาสการเงินสำหรับผู้ใหญ่') }}&via=wealthangels&text=คลาสการเงินสำหรับผู้ใหญ่"
   onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"
   target="_blank" title="คลาสการเงินสำหรับผู้ใหญ่"><i class="fa fa-twitter"></i> Tweet</a></li>
        </ul>
...
<ul id="posts-nav" class="margin-top-0 margin-bottom-45">
    <li class="next-post">
        <a href="{{ url('คำนวณการเงินแบบง่ายๆ') }}"><span>Next</span>
        คำนวณการเงินแบบง่ายๆ</a>
    </li>
    <li class="prev-post">
        <a href="{{ url('คลาสสอนการเงินให้เด็กก่อนวัยรุ่น') }}"><span>Previous </span>
        คลาสสอนการเงินให้เด็กก่อนวัยรุ่น</a>
    </li>
</ul>
            ...
            <h3>เรื่องอื่นๆ ที่เกี่ยวข้อง</h3>
				<ul class="widget-tabs">
					...
					<li>
						<div class="widget-content">
							<div class="widget-text">
								<h5><a href="{{ url('บทความการเงิน') }}">บทความการเงิน</a></h5>
							</div>
							<div class="clearfix"></div>
						</div>
					</li>
					...
					<li>
						<div class="widget-content">
							<div class="widget-text">
								<h5><a href="{{ url('คลาสสอนการเงินให้เด็กก่อนวัยรุ่น') }}">คลาสสอนการเงินให้เด็กก่อนวัยรุ่น </a></h5>
							</div>
							<div class="clearfix"></div>
						</div>
					</li>
					...
					<li>
						<div class="widget-content">
							<div class="widget-text">
								<h5><a href="{{ url('คลาสการเงินสำหรับผู้ใหญ่') }}">คลาสการเงินสำหรับผู้ใหญ่</a></h5>
							</div>
							<div class="clearfix"></div>
						</div>
					</li>
					...
					<li>
						<div class="widget-content">
							<div class="widget-text">
								<h5><a href="{{ url('คำนวณการเงินแบบง่ายๆ') }}">คำนวณการเงินแบบง่ายๆ</a></h5>
							</div>
							<div class="clearfix"></div>
						</div>
					</li>
                ...
                <a href="#" class="blog-compact-item-container">
						<div class="blog-compact-item">
							...
							<div class="blog-compact-item-content">
								...
								<h3>วางแผนการลงทุน</h3>
								<p>การวางแผนลงทุนเป็นส่วนสำคัญที่ทำให้สินทรัพย์งอกเงย โดยแนวทางการวางแผนของแต่ละบุคคลจะแตกต่างกันไปขึ้นอยู่กับปัจจัยหลายอย่างที่เราต้องนำมาพิจารณา บริการของเราจะครอบคลุมในเรื่องต่างๆดังนี้​</p>
							</div>
						</div>
					</a> -->
			</div>
