			...
			<li data-index="rs-1" data-transition="fade" data-slotamount="default" 
             ...
             data-saveperformance="off">
				...
				<div class="tp-caption custom-caption-2 tp-shape tp-shapewrapper tp-resizeme rs-parallaxlevel-0" 
					...
					data-responsive="off"
					style="z-index: 6; color: #fff; letter-spacing: 0px; font-weight: 600; ">คำนวณการเงินแบบง่ายๆ</div>
...
<ul id="posts-nav" class="margin-top-0 margin-bottom-45">
    <li class="next-post">
        <a href="{{ url('คลาสสอนการเงินให้เด็กก่อนวัยรุ่น') }}"><span>Next</span>
        คลาสสอนการเงินให้เด็กก่อนวัยรุ่น</a>
    </li>
    <li class="prev-post">
        <a href="{{ url('คลาสการเงินสำหรับผู้ใหญ่') }}"><span>Previous </span>
