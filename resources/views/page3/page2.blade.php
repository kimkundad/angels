			...
			<li data-index="rs-1" data-transition="fade" data-slotamount="default" 
             ...
             data-saveperformance="off">
				...
				<div class="tp-caption custom-caption-2 tp-shape tp-shapewrapper tp-resizeme rs-parallaxlevel-0" 
					...
					data-responsive="off"
					style="z-index: 6; color: #fff; letter-spacing: 0px; font-weight: 600; ">ประกันวินาศภัย</div>
...
<div class="blog-post single-post">
    ...
    <div class="post-content">
        ...
        <h3>ประกันวินาศภัย</h3>


        <p>
        การเลือกซื้อประกันวินาศภัย คือการเลือกซื้อความคุ้มครองป้องกันความเสี่ยงทั้งทางด้านบุคคล และทรัพย์สิน รูปแบบสัญญา มักมีความซับซ้อน 
        ทางทีมงานของเราสามารถเลือกคัดสรรคู่สัญญาที่เหมาะสมกับโจทย์ในชีวิตของท่านที่มักจะแตกต่างกันไปตามแต่ละบุคคล​​
</p>
		...
		<li><a class="fb-share" href="https://www.facebook.com/sharer/sharer.php?u={{ url('/ประกันวินาศภัย') }}&t=ประกันวินาศภัย"
   onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"
   target="_blank" title="ประกันวินาศภัย"><i class="fa fa-facebook"></i> Share</a></li>
            <li><a class="twitter-share" href="https://twitter.com/share?url={{ url('/ประกันวินาศภัย') }}&via=wealthangels&text=ประกันวินาศภัย"
   onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"
   target="_blank" title="ประกันวินาศภัย"><i class="fa fa-twitter"></i> Tweet</a></li>
        </ul>
            ...
            <h3>เรื่องอื่นๆ ที่เกี่ยวข้อง</h3>
				<ul class="widget-tabs">
					...
					<li>
						<div class="widget-content">
							<div class="widget-text">
								<h5><a href="{{ url('ประกันชีวิต') }}">ประกันชีวิต</a></h5>
							</div>
							<div class="clearfix"></div>
						</div>
					</li>
					...
					<li>
						<div class="widget-content">
							<div class="widget-text">
								<h5><a href="{{ url('ประกันวินาศภัย') }}">ประกันวินาศภัย </a></h5>
							</div>
							<div class="clearfix"></div>
						</div>
					</li>
					...
					<li>
						<div class="widget-content">
							<div class="widget-text">
								<h5><a href="{{ url('กองทุนรวม') }}">กองทุนรวม</a></h5>
							</div>
							<div class="clearfix"></div>
						</div>
					</li>
