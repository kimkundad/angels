...
<div class="blog-post single-post">
    ...
    <div class="post-content">
        ...
        <p>
        การลงทุนในสภาวะตลาด ณ ปัจจุบันมีความผันผวนสูง การกระจายการลงทุนไปสินทรัพย์ทางเลือกที่มีความสัมพันธ์กับสินทรัพย์ทางการเงินอื่นต่ำ <br>
...
<ul id="posts-nav" class="margin-top-0 margin-bottom-45">
    <li class="next-post">
        <a href="{{ url('ประกันชีวิต') }}"><span>Next</span>
        ประกันชีวิต</a>
    </li>
    <li class="prev-post">
        <a href="{{ url('กองทุนรวม') }}"><span>Previous </span>
        กองทุนรวม</a>
    </li>
</ul>
