			...
			<li data-index="rs-1" data-transition="fade" data-slotamount="default" 
             ...
             data-saveperformance="off">
				...
				<div class="tp-caption custom-caption-2 tp-shape tp-shapewrapper tp-resizeme rs-parallaxlevel-0" 
					...
					data-responsive="off"
					style="z-index: 6; color: #fff; letter-spacing: 0px; font-weight: 600; ">กองทุนรวม</div>
...
<div class="blog-post single-post">
    ...
    <div class="post-content">
        ...
        <p>
        ปัจจุบันกองทุนรวมมีหลากหลายมีให้เลือกจากหลายสถาบัน ทีมงานของเราสามารถช่วยแนะนำให้ท่านสามารถเลือกจัดการพอร์ตการลงทุนเพื่อให้เหมาะสมกับเป้าหมายทางการลงทุน <br>
		...
		<li><a class="fb-share" href="https://www.facebook.com/sharer/sharer.php?u={{ url('/กองทุนรวม') }}&t=กองทุนรวม"
   onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"
   target="_blank" title="กองทุนรวม"><i class="fa fa-facebook"></i> Share</a></li>
            <li><a class="twitter-share" href="https://twitter.com/share?url={{ url('/กองทุนรวม') }}&via=wealthangels&text=กองทุนรวม"
   onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"
   target="_blank" title="กองทุนรวม"><i class="fa fa-twitter"></i> Tweet</a></li>
        </ul>
